...
import battlecode.schema.BreakDirt;
import battlecode.schema.CatFeed;
import battlecode.schema.CatScratch;
import battlecode.schema.CheesePickup;
import battlecode.schema.CheeseSpawn;
import battlecode.schema.CheeseTransfer;
import battlecode.schema.DamageAction;
import battlecode.schema.DieAction;
import battlecode.schema.DieType;
import battlecode.schema.Event;
import battlecode.schema.EventWrapper;
...
import battlecode.schema.IndicatorDotAction;
import battlecode.schema.IndicatorLineAction;
import battlecode.schema.IndicatorStringAction;
import battlecode.schema.MatchFooter;
import battlecode.schema.MatchHeader;
import battlecode.schema.PlaceDirt;
import battlecode.schema.PlaceTrap;
import battlecode.schema.ProfilerEvent;
import battlecode.schema.ProfilerFile;
import battlecode.schema.ProfilerProfile;
import battlecode.schema.RatAttack;
import battlecode.schema.RatNap;
import battlecode.schema.RatSqueak;
import battlecode.schema.RemoveTrap;
import battlecode.schema.RobotTypeMetadata;
import battlecode.schema.Round;
import battlecode.schema.SpawnAction;
import battlecode.schema.StunAction;
import battlecode.schema.TeamData;
import battlecode.schema.ThrowRat;
import battlecode.schema.TimelineMarker;
import battlecode.schema.TriggerTrap;
import battlecode.schema.Turn;
import battlecode.schema.UpgradeToRatKing;
