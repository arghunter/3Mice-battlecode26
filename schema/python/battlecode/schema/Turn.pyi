...
class Turn(object):
  ...
  def X(self) -> int: ...
  def Y(self) -> int: ...
  def ActionsType(self, i: int) -> typing.Literal[Action.NONE, Action.CatFeed, Action.RatAttack, Action.RatNap, Action.RatCollision, Action.PlaceDirt, Action.BreakDirt, Action.CheesePickup, Action.CheeseSpawn, Action.CatScratch, Action.CatPounce, Action.PlaceRatTrap, Action.PlaceCatTrap, Action.TriggerRatTrap, Action.TriggerCatTrap, Action.DamageAction, Action.SpawnAction, Action.DieAction, Action.IndicatorStringAction, Action.IndicatorDotAction, Action.IndicatorLineAction]: ...
